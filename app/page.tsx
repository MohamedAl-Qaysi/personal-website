          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="fade-up">
              ...
              <p className="text-base leading-relaxed mb-8 max-w-xl" style={{ color: "#858EAD" }}>
                Final-semester Software Engineering student with{" "}
                <span className="text-white font-semibold">5+ years</span> of real-world
                experience — from delivering{" "}
                <span className="text-white font-semibold">50+ client projects</span> and co-founding a game, to
                Android apps, banking systems, UX research, and enterprise compliance software.
                I apply AI to automate workflows and{" "}
                <span className="text-white font-semibold">boost efficiency</span>.
              </p>
